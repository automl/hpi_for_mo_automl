...
project_urls = {
    ...
    "Source Code": "https://github.com/automl/hpi_for_mo",
}
copyright = f"Copyright {datetime.date.today().strftime('%Y')}, Daphne Theodorakopoulos, Frederic Stahl and Marius Lindauer"
version = "0.0.1"
